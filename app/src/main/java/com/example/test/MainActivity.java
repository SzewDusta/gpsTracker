                            ...
                            .requestLocationUpdates(locationRequest, new LocationCallback() {
                                ...
                                public void onLocationResult(@NonNull LocationResult locationResult) {
                                    ...
                                    if (locationResult != null && locationResult.getLocations().size() >0){
                                        ...
                                        Log.d("lonngitude", ""+longitude);
                                        try {
                                            List<Address>listAdress = geocoder.getFromLocation(latitude, longitude, 1);
                                            Log.d("address", ""+listAdress.get(0).getCountryName());
                                            String country = listAdress.get(0).getAddressLine(0);
                                            Details.setText(""+country);
...
//
                                        //Toast.makeText(MainActivity.this, ""+listAdress, Toast.LENGTH_SHORT).show();
//                                        try {
//
